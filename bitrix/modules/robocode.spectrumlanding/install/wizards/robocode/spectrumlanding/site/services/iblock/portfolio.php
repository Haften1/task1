...
$iblockCode = "portfolio_".WIZARD_SITE_ID; 
...
if($iblockID == false)
{
	...
	WizardServices::IncludeServiceLang("portfolio.php");
   
	$arrPropertiesTab = array(
		array("edit1", GetMessage("PORTFOLIO_TAB_NAME")),	
		array("ACTIVE", GetMessage("PORTFOLIO_FIELD_ACTIVE")),
		array("NAME", GetMessage("PORTFOLIO_FIELD_NAME")),
	 );

	$arrPropertiesTab = array_merge($arrPropertiesTab, $arAllProperties);	
	
	$afterPropFields = array(
			array("PREVIEW_PICTURE", GetMessage("PORTFOLIO_FIELD_PREVIEW_PICTURE")),
	);
