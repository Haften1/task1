...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/testimonials.xml"; 
$iblockCode = "testimonials_".WIZARD_SITE_ID; 
...
if($iblockID == false)
{
	...
	$arFields = Array(
		...
		"FIELDS" => array ( 
					...
					'PREVIEW_PICTURE' => array ( 'IS_REQUIRED' => 'N', 
	...
	WizardServices::IncludeServiceLang("testimonials.php");
   
	$arrPropertiesTab = array(
		array("edit1", GetMessage("TESTIMONIALS_TAB_NAME")),	
		array("ACTIVE", GetMessage("TESTIMONIALS_FIELD_ACTIVE")),
		array("NAME", GetMessage("TESTIMONIALS_FIELD_NAME")),
	 );

	$arrPropertiesTab = array_merge($arrPropertiesTab, $arAllProperties);	
	
	$afterPropFields = array(
			array("PREVIEW_PICTURE", GetMessage("TESTIMONIALS_FIELD_PREVIEW_PICTURE")),
			array("PREVIEW_TEXT", GetMessage("TESTIMONIALS_FIELD_PREVIEW_TEXT")),
	);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("TESTIMONIALS_IBLOCK_ID" => $iblockID));
?>