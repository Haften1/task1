...
if($iblockID == false)
{
	...
	WizardServices::IncludeServiceLang("team.php");
   
	$arrPropertiesTab = array(
		array("edit1", GetMessage("TEAM_TAB_NAME")),	
		array("ACTIVE", GetMessage("TEAM_FIELD_ACTIVE")),
		array("NAME", GetMessage("TEAM_FIELD_NAME")),
	 );

	$arrPropertiesTab = array_merge($arrPropertiesTab, $arAllProperties);	
	
	$afterPropFields = array(
			array("PREVIEW_PICTURE", GetMessage("TEAM_FIELD_PREVIEW_PICTURE")),
	);
