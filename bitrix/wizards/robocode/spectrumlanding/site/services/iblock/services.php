...
if($iblockID == false)
{
	...
	$arrPropertiesTab = array(
		array("edit1", GetMessage("SERVICES_TAB_NAME")),	
		array("ACTIVE", GetMessage("SERVICES_FIELD_ACTIVE")),
		array("NAME", GetMessage("SERVICES_FIELD_NAME")),
		array("SORT", GetMessage("SERVICES_FIELD_SORT")),
	 );

	$arrPropertiesTab = array_merge($arrPropertiesTab, $arAllProperties);	
	
	$afterPropFields = array(
			array("PREVIEW_PICTURE", GetMessage("SERVICES_FIELD_PREVIEW_PICTURE")),
			array("PREVIEW_TEXT", GetMessage("SERVICES_FIELD_PREVIEW_TEXT")),
	);
