...
if($iblockID == false)
{
	...
	$arrPropertiesTab = array(
		array("edit1", GetMessage("PARTNERS_TAB_NAME")),	
		array("ACTIVE", GetMessage("PARTNERS_FIELD_ACTIVE")),
		array("NAME", GetMessage("PARTNERS_FIELD_NAME")),
	 );

	$arrPropertiesTab = array_merge($arrPropertiesTab, $arAllProperties);	
	
	$afterPropFields = array(
			array("PREVIEW_PICTURE", GetMessage("PARTNERS_FIELD_PREVIEW_PICTURE")),
	);
