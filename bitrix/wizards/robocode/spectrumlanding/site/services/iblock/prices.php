...
$iblockCode = "prices_".WIZARD_SITE_ID; 
...
if($iblockID == false)
{
	...
	WizardServices::IncludeServiceLang("prices.php");
   
	$arrPropertiesTab = array(
		array("edit1", GetMessage("PRICES_TAB_NAME")),	
		array("ACTIVE", GetMessage("PRICES_FIELD_ACTIVE")),
		array("NAME", GetMessage("PRICES_FIELD_NAME")),
	 );
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("PRICES_IBLOCK_ID" => $iblockID));
?>